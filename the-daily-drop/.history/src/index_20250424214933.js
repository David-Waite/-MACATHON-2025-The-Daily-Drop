...
import { BrowserRouter, Routes, Route } from "react-router"; // Correct import spelling 'react-router-dom'
...
import { PublicRoute } from "./routes/PublicRoute"; // Adjust path if needed
